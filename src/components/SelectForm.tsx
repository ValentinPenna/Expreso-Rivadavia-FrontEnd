...
const SelectForm: React.FC = () => {
  ...
  return (
    <div>
      {!selectForm && (
        <div className="m-16 grid grid-cols-1 lg:grid-cols-2 gap-10 ">
          <div className="bg-white p-12 rounded-lg  text-center shadow-lg flex flex-col items-center">
            ...
            <Button onClick={() => setSelectForm("user")} className="m-8 mt-16">
          ...
          <div className="bg-white p-12 rounded-lg text-center shadow-lg flex flex-col items-center">
            ...
            >
              <path
                fill="#CB1B1A"
                d="M4 21q-.825 0-1.412-.587T2 19V8q0-.825.588-1.412T4 
            ...
            11.5t-1.412.588T10 13.5t.588 1.413T12 15.5"
              />
            </svg>

            <Button
              onClick={() => setSelectForm("company")}
              className="m-8 mt-16"
            >
              Registrarse como empresa{" "}
            </Button>
          </div>
          <div className="lg:text-3xl m-10 text-center bg-white p-10 rounded-lg shadow-lg col-span-1 lg:col-span-2">
            <span className="m-5">
              Ya tienes cuenta?
      ...
      {selectForm === "user" && (
        <RegisterUser handleBackToSelection={handleBackToSelection} />
      )}
      {selectForm === "company" && (
        <RegisterCompany handleBackToSelection={handleBackToSelection} />
      )}
    </div>
  );
};
