...
const SelectForm: React.FC = () => {
  ...
  return (
    <div>
      {!selectForm && (
        <div className='m-10 grid grid-cols-1 lg:grid-cols-2 gap-10 '>
            <div className='bg-white p-14 rounded-lg shadow-lg text-center border border-primary flex flex-col items-center'> 
            ...
            <Button onClick={()=> setSelectForm('user')} className='m-10'>Registrarse como persona</Button>
            </div>
            <div className='bg-white p-14 rounded-lg shadow-lg text-center border border-primary flex flex-col items-center'>
            ...
            <Button onClick={()=>setSelectForm('company')} className='m-10'>Registrarse como empresa </Button>
            </div>
        </div>
      )}
