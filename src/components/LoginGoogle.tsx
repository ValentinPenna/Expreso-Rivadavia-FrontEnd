...
const LoginGoogle = () => {
  ...
  return (
    <div className="flex flex-row">
      <button
        className="text-sm p-2 rounded-full border-primary border-2 w-fit  bg-white text-primary transition-all duration-200 text-center flex items-center justify-center gap-2"
