...
export default function UserInfoDashboard() {
    ...
    return (
        <div className="w-full my-4 bg-white px-24 pb-24 pt-20 rounded-l-lg flex flex-col max-w-[80%]">
            ...
            {   
                editionMode?
                <button onClick={() => setEditionMode(!editionMode)} className="bg-primary text-white text-lg font-bold px-6 py-2 rounded-md hover:bg-white hover:text-primary border-2 border-primary">Guardar</button>
                :
                <button onClick={() => setEditionMode(!editionMode)} className="bg-primary text-white text-lg font-bold px-6 py-2 rounded-md hover:bg-white hover:text-primary border-2 border-primary">Editar</button>
            }
            </div>
