    ...
    return (
        ...
        <>
            <button className="" onClick={() => location.href='/dashboard'}>
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24" preserveAspectRatio="none">
                    <path fill="#CB1B1A" d="M12 12q-1.65 0-2.825-1.175T8 8t1.175-2.825T12 
